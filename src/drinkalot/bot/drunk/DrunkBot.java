...
public class DrunkBot extends PircBot {
    ...
    public DrunkBot(String name, String botMaster) {
        this.setName(name);
        this.master = botMaster;
    ...
    protected void onInvite(String targetNick, String sourceNick, String sourceLogin, String sourceHostname, String channel) {
        System.out.println("Invited to " + channel);
        if (this.master != null && sourceNick.equals(this.master)) {
